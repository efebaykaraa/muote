...
pub fn shadow_details(
    ...
    let (r, g, b, a) = engyls::config::parse_color_to_rgba(&model.settings.appearance.shadow_color);
    ...
    let (_, _, _, alpha) =
        engyls::config::parse_color_to_rgba(&model.settings.appearance.shadow_color);
